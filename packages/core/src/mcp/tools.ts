...

    {
      ...
      inputSchema: {
        ...
        properties: {
          ...
          assigned_to: { type: 'string', description: 'Who the task is assigned to (team member / peer name)' },
        },
        required: ['title'],
      },
      async handler(args: Record<string, unknown>): Promise<unknown> {
    ...
    },
    {
      ...
      inputSchema: {
        ...
        properties: {
          ...
          assigned_to: { type: 'string', description: 'Reassign the task to a different person' },
        },
        required: ['id'],
      },
      async handler(args: Record<string, unknown>): Promise<unknown> {
